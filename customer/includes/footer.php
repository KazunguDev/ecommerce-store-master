  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <p>
          <strong>KazunguDev Inc.</strong>
          <br>Nairobi
          <br>Kenya
          <br>+254 716 965 567
          <br>Kazungudev5@gmail.com
          <br>
          <strong>KazunguDev</strong>
        </p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-6 d-flex flex-row">
        <p>&copy; 2023 KazunguDev</p>
      </div>
      <div class="col-6 d-flex flex-row-reverse">
        <p>Template by <a class="" href="https://www.linkedin.com/in/gisore-brian-34216857/" target="_blank">KazunguDev</a></p>
      </div>
    </div>
  </div>
</div>
